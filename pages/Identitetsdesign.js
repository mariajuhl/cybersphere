...
export default function Identitetsdesign() {
    ...
    return (
        <main>
            ...
            <div>
            <h1 className="mindreFont">Identitetsdesign</h1>
            
            <p>
            En visuel identitet er din mulighed for at udtrykke dig gennem farver, skrifttyper, grafiske elementer og selvfølgelig et logo. Det er jeres virksomhedens ansigt udadtil, og dermed et helt afgørende element når det kommer til at kunne adskiller sig fra jeres konkurrenter.
            </p>
            </div>
            </section>
            ...
            <section className="venstrestillet">
                ...
                <br></br>
                <br></br>
                Vi hjælper etablerede virksomheder såvel som startups med at få en identitet, der afspejler deres brands sande personlighed.                </p>
            </section>
